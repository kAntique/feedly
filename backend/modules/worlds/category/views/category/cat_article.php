...
<div class="box">
  ...
  <textarea  id="text" name="iframe_allcat_clip"  style="width:100%"><iframe src="<?php echo Yii::$app->params['url_cat_article'];?>" scrolling="auto" width="100%" height="100%" frameborder="0" ></iframe></textarea>
</div>
