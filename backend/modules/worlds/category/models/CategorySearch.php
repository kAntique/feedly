...
/**
 * CategorySearch represents the model behind the search form about `backend\modules\worlds\category\models\Category`.
 */
class CategorySearch extends Category
{
    ...
    {
        return [
            [['id', 'rate_id', 'world_id', 'cover_img_id'], 'integer'],
